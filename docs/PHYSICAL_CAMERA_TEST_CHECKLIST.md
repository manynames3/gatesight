...
- [ ] Manual capture takes five candidates, selects four distinct JPEG frames, and reports useful lighting/glare/distance guidance on rejection.
...
- [ ] Expired or interrupted upload receives fresh instructions for missing frames.
- [ ] Guide-aligned detection works; a deliberately misaligned plate exercises full-frame fallback.
...
- [ ] A successful first heartbeat commissions a station; untouched logical gates do not create stale-station attention.
